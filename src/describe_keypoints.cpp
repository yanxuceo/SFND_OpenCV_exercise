...
/**
 *  BRISK and SIFT implementation and performance comparison
 */
...
void descKeypoints1()
{
    ...
    // Add the SIFT detector / descriptor, compute the time for both steps and compare both BRISK and SIFT
